...
odoo.define("website_product_configurator_restriction.FieldBooleanButtonWeb", function (require) {
    "use strict";
    ...
    var FieldBooleanButtonWeb = basic_fields.FieldBoolean.extend({
    ...
    registry.add("boolean_button_web", FieldBooleanButtonWeb);
    return FieldBooleanButtonWeb;
});
