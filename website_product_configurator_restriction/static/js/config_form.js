odoo.define("website_product_configurator_restriction_restriction.config_form", function(require) {
    "use strict";
    ...
    publicWidget.registry.ProductConfigurator = publicWidget.Widget.extend({
        ...
        start: function() {
            ...
            this.$(".product_config_datetimepicker").parent().datetimepicker(this.datetimepickers_options);
            this.$(".product_config_datepicker").parent().datetimepicker(this.datepickers_options);
            return def;
        },
        ...
        _onChangeConfigAttribute: function(event) {
            ...
            if (flag) {
                ...
                ajax.jsonRpc("/website_product_configurator_restriction/onchange", "call", {
        ...
        _onChangeConfigStep: function(event, next_step) {
            ...
            if (flag) {
                ...
                return ajax
                    .jsonRpc(
                        "/website_product_configurator_restriction/save_configuration",
                        "call", {
                            form_values: form_data,
